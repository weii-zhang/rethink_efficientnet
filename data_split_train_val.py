...
#切分训练集、验证集，并进行补边处理
def split_train_val(img_dir,save_dir,train_rate):
    '''
    ...
    for class_dir in img_dir_list:
        ...
        img_list=glob.glob(class_dir+os.sep+"*.[pj][np]g") #获取每个类别文件夹下的所有图片
        ...
        print(class_name+" train num",len(train_list))
        print(class_name+" val num",len(img_list)-len(train_list))
...
if __name__ == "__main__":
    split_train_val('/mnt/nas-new/home/zhanggefan/dataset/prediction/train_val_1101', '/mnt/nas-new/home/zhanggefan/dataset/prediction/train_val_1101_1', 0.8)
