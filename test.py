...
class Test_model():
    def __init__(self,opt,weights):
        ...
        self.model.eval()
        self.class_name={'ng': 0, 'ok': 1}  #类别信息
...
def parser_opt():
    parser = argparse.ArgumentParser()
    parser.add_argument("--test-dir", type=str, default="/mnt/nas-new/home/zhanggefan/dataset/prediction/train_val_test_1103/test", help="Directory containing test images")
    parser.add_argument("--weights-dir", type=str, default="/mnt/nas-new/home/zhanggefan/zw/efficientnet/weights/1103", help="Directory containing model weights")
    parser.add_argument("--imgsz", type=int, default=512, help="Test image size")
    opt = parser.parse_known_args()[0]
    return opt
